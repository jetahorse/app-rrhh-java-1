...
public class BuscarPorIdTest {
    ...
    @Test
    public void testMetodoBuscarPorId(){
        ...
        empDao.crear(e1);
        Empleado e=empDao.buscarPorId(1);
        Contratado empCont= (Contratado) e;
        assertEquals(e1.getNombre(),empCont.getNombre());
        assertEquals(e1.getCorreo(),empCont.getCorreo());
        assertEquals(e1.getCuil(),empCont.getCuil());
        assertEqualDates(e1.getFechaDeIngreso(),empCont.getFechaDeIngreso());
        assertEquals(e1.getMontoHoraTrabajada(),empCont.getMontoHoraTrabajada());
        assertEquals(e1.getHorasTrabajadas(),empCont.getHorasTrabajadas());
